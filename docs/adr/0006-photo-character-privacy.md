...
been assessed here and is an open owner decision. Update 2026-09-14 (#397): Gemini left the pipeline entirely — the photo **descriptor** and portrait render, the image judge and page generation are all xAI Grok now. The child's photo goes to xAI (US), not Google. Lateral to the Google posture assessed below, recorded here for the owner.* **Alibaba Qwen was rejected** — competitive on image
