...
**Открытые рекомендации аудита:** #162 batch-eval (главный verification-пробел — качество текста защищено только ручными прогонами), чистка 229 permissions в `settings.local.json`.
