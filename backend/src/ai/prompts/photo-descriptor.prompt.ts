...
If hasChildFace is true, write descriptor as ONE compact English line naming the
STABLE identity features an illustrator needs:
...
- Prefer stable traits. DOWNWEIGHT transient or awkward-to-draw details: describe
  a tooth gap as "a small gap between the front teeth", never "missing teeth";
