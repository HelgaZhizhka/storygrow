...
const TEMPLATES: TemplateDefinition[] = [
  {
    ...
    content: templateContentSchema.parse({
      pages: [
        ...
        {
          pageNumber: 2,
          text: 'В парке на скамейке сидел{{|а}} маленький{{|ая}} ребёнок и смотрел{{|а}} на землю. Рядом не было ни игрушек, ни друзей. {{childName}} заметил{{|а}} это и на секунду остановил{{|ся|лась}}. «Почему {{он|она}} такой{{|ая}} грустный{{|ая}}?» — {{подумал|подумала}} {{childName}}.',
          illustrationTag: 'sad',
        },
        {
          pageNumber: 3,
          text: '{{childName}} немного {{помедлил|помедлила}} — ведь робот был таким любимым! Но потом {{решительно|решительно}} подошёл{{|а}} и протянул{{|а}} игрушку: «Привет! Хочешь поиграть вместе? Я {{childName}}». Незнакомый{{|ая}} малыш{{|ка}} удивлённо посмотрел{{|а}} и робко улыбнул{{|ась}}.',
        ...
        {
          pageNumber: 5,
          text: 'Вечером {{childName}} {{лежал|лежала}} в кровати и улыбал{{|ась}}. Робот стоял рядом — такой же любимый, как всегда. Но теперь {{он|она}} знал{{|а}}: когда делишься с другими, радости становится вдвое больше. Делиться — значит дарить частичку себя.',
          illustrationTag: 'happy',
        },
      ],
    }),
